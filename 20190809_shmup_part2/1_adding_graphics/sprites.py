...
class Player(pygame.sprite.Sprite):
	def __init__(self, game):
		...
		self.game = game
		self.image = self.game.player_img # 修改
		# self.image.fill(GREEN) 刪除
	...
	def shoot(self):
		bullet = Bullet(self.game, self.rect.centerx, self.rect.top) # 修改
		self.game.all_sprites.add(bullet)
		self.game.bullets.add(bullet)

class Mob(pygame.sprite.Sprite):
	def __init__(self, game):  # 修改
		pygame.sprite.Sprite.__init__(self)
		self.game = game # 新增
		self.image = self.game.mob_img # 修改
		# self.image.fill(RED) 刪除
		self.rect = self.image.get_rect()
...
class Bullet(pygame.sprite.Sprite):
	def __init__(self, game, x, y): # 修改
		pygame.sprite.Sprite.__init__(self)
		self.game = game # 新增
		self.image = self.game.bullet_img # 修改
		# self.image.fill(YELLOW) 刪除
		self.rect = self.image.get_rect()
		self.rect.bottom = y
		self.rect.centerx = x
		self.speed_y = -10
