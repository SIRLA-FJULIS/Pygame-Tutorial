...
class Game:
	...
	def load_data(self):
		...
		self.player_img_orig = pygame.image.load(path.join(self.img_dir, 'playerShip1_orange.png')).convert() # 修改
		self.player_img = pygame.transform.scale(self.player_img_orig, (50, 38)) # 修改
		...
		self.player_die_sound = pygame.mixer.Sound(path.join(self.snd_dir, 'rumble1.ogg')) # 新增
	...
	def draw(self):
		...
		self.draw_lives(self.gameDisplay, DISPLAY_WIDTH - 100, 5, self.player.lives, self.player_mini_img) # 新增
