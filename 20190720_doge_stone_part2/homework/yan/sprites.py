...
class Stone:
	def __init__(self, game):
		...
		self.stoneImg = pygame.image.load('Stone.jpg')
...
class Carrot:
	def __init__(self, game):
		...
		self.rect = self.carrotImg.get_rect()
		self.rect.topleft = (self.pos_x, self.pos_y)
	...
	def draw(self):
		self.game.gameDisplay.blit(self.carrotImg, (self.pos_x, self.pos_y))
...
class Specialcarrot:
	def __init__(self, game):
		...
		self.pos_y = -50
		self.speed_y = randint(3, 7)
		self.specialcarrotImg = pygame.image.load('specialcarrot.png')
		self.rect = self.specialcarrotImg.get_rect()
		self.rect.topleft = (self.pos_x, self.pos_y)
	...
	def draw(self):
		self.game.gameDisplay.blit(self.specialcarrotImg, (self.pos_x, self.pos_y))